...
public class ServedShoppingCartTest {
    ...
    public void shouldGetShoppingCartPrice() {
        ...
        ComponentInShoppingCart mouse = new ComponentInShoppingCart(servedShoppingCart, new Component("mouse", "This is a mouse", 50, 55), 2);
        ComponentInShoppingCart keyboard = new ComponentInShoppingCart(servedShoppingCart, new Component("keyboard", "This is a regular USB keyboard", 50, 30), 1);
        ComponentInShoppingCart display = new ComponentInShoppingCart(servedShoppingCart, new Component("display", "This is a big computer dispolay", 150, 20), 1);
