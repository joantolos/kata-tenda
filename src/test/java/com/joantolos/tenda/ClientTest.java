...
public class ClientTest {
    ...
    public void shouldGetInterestsForDate() {
        ...
        Component mouse = new BasicComponent("mouse", "This is a mouse", 50, 55);
        Component keyboard = new BasicComponent("keyboard", "This is a regular USB keyboard", 50, 30);
        Component display = new BasicComponent("display", "This is a big computer dispolay", 150, 20);
